import classes from "./O_nama.module.css";
const O_nama = () => {
    return(
        <div className={classes.mainPart}>
          ...
          <p><h1 className={classes.h1Part}>O platformi</h1></p>
          ...
          <p><h1 className={classes.h1Part}>Zašto je važno podržati male proizvođače?</h1></p>
          <p><h2>Ekonomija</h2></p>
